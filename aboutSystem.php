      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Pizza Palace</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">We have the Best Pizza Chefs</h2>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Pizza Palace.</strong></h3>
            <h3><strong>A Leading Pizza Delivery System.</strong></h3>
            <p class="font-italic">
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="https://twitter.com/Twitter" target="_blank"><i class="icofont-twitter"></i></a>
                  <a href="https://www.instagram.com/explore/tags/homemadepizza/" target="_blank"><i class="fab fa-instagram"></i></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="https://twitter.com/Twitter" target="_blank"><i class="icofont-twitter" target="_blank"></i></a>
                  <a href="https://www.instagram.com/explore/tags/homemadepizza/" target="_blank"><i class="fab fa-instagram"></i></a>
                  <a href="https://www.linkedin.com/" target="_blank"><i class="icofont-linkedin" target="_blank"></i></a>
                </div>
              </div>
