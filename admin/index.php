<?php error_reporting(0); 
    ...
    if(isset($_SESSION['adminloggedin']) && $_SESSION['adminloggedin']==true){
        $adminloggedin= true;
        $customer_id = $_SESSION['admincustomer_id'];
    }
    else{
        $adminloggedin = false;
        $customer_id = 0;
...
<head>
    ...
    <link rel = "icon" href ="/pizza-delivery/img/logo.jpg" type = "image/x-icon">
...
<body id="body-pd" style="background: #80808045;">
    ...
    <?php error_reporting(0); include $page.'.php' ?>
...
<?php error_reporting(0);
        ...
        header("location: /pizza-delivery/admin/login.php");
    }
?>