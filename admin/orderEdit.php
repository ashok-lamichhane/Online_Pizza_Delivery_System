        ...
        <table class="table table-striped table-hover text-center" id="NoOrder">
            ...
            <tbody>
                <?php error_reporting(0);
                    ...
                    if($counter==0) {
                        ?><script> document.getElementById("NoOrder").innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%"> You have not received any Order!	</div>';</script> <?php error_reporting(0);
                    } 
                ?>
            </tbody>
        </table>
