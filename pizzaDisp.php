...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        <?php error_reporting(0);
            ...
            $sql = "SELECT * FROM `pizza_items` WHERE pizza_id = $pizza_id";
        ...
        ?>
        <script> document.getElementById("title").innerHTML = "<?php error_reporting(0); echo $pizza_Name; ?>"; </script> 
        <?php error_reporting(0);
        echo  '<div class="col-md-4">
                <img src="img/pizza-'.$pizza_id. '.jpg" width="249px" height="262px">
            </div>
            <div class="col-md-8 my-4">
                <h3>' . $pizza_Name . '</h3>
                <h5 style="color: #ff0000">Tk. '.$pizza_Price. '/-</h5>
                <p class="mb-0">' .$pizza_Description .'</p>';
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        ...
                        echo '<a href="cartDisp.php"><button class="btn btn-primary my-2">Go to Cart</button></a>';
                    }
                }
                else{
                ...
                <div class="mx-4">
                    <a href="pizzaListDisp.php?resid=' . $pizza_res_id . '" class="active text-dark">
