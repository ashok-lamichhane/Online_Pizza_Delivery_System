...
<body>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php error_reporting(0);
            $id = $_GET['resid'];
            $sql = "SELECT * FROM `pizza_items` WHERE pizza_res_id = $id";
            $result = mysqli_query($conn, $sql);
            $noResult = true;
            while($row = mysqli_fetch_assoc($result)){
                $noResult = false;
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            echo '</form>                            
                                <a href="pizzaDisp.php?pizzaid=' . $pizza_id . '" class="mx-2"><button class="btn btn-primary">Quick View</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
            ...
            if($noResult) {
                echo '<div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <p class="display-4">Sorry In this restaurant, no items are available.</p>
    ...
    <script> 
        document.getElementById("title").innerHTML = "<?php error_reporting(0); echo $resname; ?>"; 
        document.getElementById("catTitle").innerHTML = "<?php error_reporting(0); echo $resname; ?>"; 
    </script> 
</body>
</html>