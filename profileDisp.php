...
<body>
    ...
    <div class="container">
        <?php error_reporting(0); 
            $sql = "SELECT * FROM system_users WHERE id='$customer_id'"; 
        ...
        <div class="row">
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    <img class="rounded-circle mb-3 bg-dark" src="img/person-<?php error_reporting(0); echo $customer_id; ?>.jpg" onError="this.src = 'img/profilePic.jpg'" style="width:215px;height:215px;padding:1px;">
                    <form action="components/profileEdit.php" method="POST">
                    ...
                    <form action="components/profileEdit.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        <li class="username my-2"><a href="profileDisp.php">@<?php error_reporting(0); echo $username ?></a></li>
                        <li class="name"><?php error_reporting(0); echo $first_name." ".$last_name; ?>
                            <label class="label label-info">(<?php error_reporting(0); echo $user_group ?>)</label>
                        </li>
                        <li class="email"><?php error_reporting(0); echo $email ?></li>
                        <li class="my-2"><a href="components/logOut.php"><button class="btn btn-secondary" style="font-size: 15px;padding: 3px 8px;">Logout</button></a></li>
                    </ul>
                </div>
            </div>
            <div class="content-panel mb-3" style="display: flex;justify-content: center;">
                <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                    <h2 class="title text-center">Profile<span class="pro-label label label-warning"> (<?php error_reporting(0); echo $user_group ?>)</span></h2>
                
                    <form action="components/profileEdit.php" method="post">
                        <div class="form-group">
                            <b><label for="username">Username:</label></b>
                            <input class="form-control" id="username" name="username" type="text" disabled value="<?php error_reporting(0); echo $username ?>">
                        </div>
                        <div class="form-row">
                        <div class="form-group col-md-6">
                            <b><label for="first_name">First Name:</label></b>
                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" required value="<?php error_reporting(0); echo $first_name ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <b><label for="last_name">Last Name:</label></b>
                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last name" required value="<?php error_reporting(0); echo $last_name ?>">
                        </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group  col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter Your Phone Number" required pattern="[0-9]{11}" maxlength="11" value="<?php error_reporting(0); echo $phone ?>">
                                </div>
                            </div>
                            <div class="form-group  col-md-6">
