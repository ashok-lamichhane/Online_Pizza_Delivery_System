...
<body>
                    ...
                    <?php error_reporting(0);
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            echo '<tr>
                                    ...
                                    <td>' . $order_Date . '</td>
                                    <td><a href="#" data-toggle="modal" data-target="#order_Status' . $order_id . '" class="view"><i class="material-icons">&#xE5C8;</i></a></td>
                        ...
                        if($counter==0) {
                            ?><script> document.getElementById("empty").innerHTML = '<div class="col-md-12 my-5"><div class="card"><div class="card-body cart"><div class="col-sm-12 empty-cart-cls text-center"> <img src="https://i.imgur.com/dCdflKN.png" width="130" height="130" class="img-fluid mb-4 mr-3"><h3><strong>You have not ordered any items.</strong></h3><h4>Please order more to get a discount</h4> <a href="index.php" class="btn btn-primary cart-btn-transform m-3" data-abc="true">continue shopping</a> </div></div></div></div>';</script> <?php error_reporting(0);
                        }
                    ?>
                </tbody>
            </table>
    ...
    <?php error_reporting(0); 
    include 'components/orderItemForm.php';
    include 'components/orderStatusForm.php';
    require 'components/pageFooter.php';?>
