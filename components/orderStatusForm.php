...
<?php error_reporting(0); 
    $statusmodalsql = "SELECT * FROM `orders` WHERE `customer_id`= $customer_id";
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="order_Status<?php error_reporting(0); echo $orderid; ?>">Order Status</h5>
            ...
            <div class="modal-body" id="printThis">
                <div class="container" style="padding-right: 0px;padding-left: 0px;">
                    <article class="card">
                        <div class="card-body">
                            <h6><strong>Order ID:</strong> #<?php error_reporting(0); echo $orderid; ?></h6>
                            <article class="card">
                                <div class="card-body row">
                                    <div class="col"> <strong>Estimated Delivery time:</strong> <br><?php error_reporting(0); echo $time_mins; ?> minute </div>
                                    <div class="col"> <strong>Shipping By:</strong> <br> <?php error_reporting(0); echo $deliveryMan_Name; ?> | <i class="fa fa-phone"></i> <?php error_reporting(0); echo $deliveryMan_phone_num; ?> </div>
                                    <div class="col"> <strong>Status:</strong> <br> <?php error_reporting(0); echo $tstatus; ?> </div>
                                    <div class="col"> <strong>Tracking #:</strong> <br> <?php error_reporting(0); echo $trackId; ?> </div>
                                </div>
                            </article>
                            <div class="track">
                            <?php error_reporting(0);
                            ...
                            <a href="contactForm.php" class="btn btn-warning" data-abc="true">Help <i class="fa fa-chevron-right"></i></a>
                        </div>
                    </article>
                </div>
            </div>
